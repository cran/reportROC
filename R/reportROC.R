reportROC=function(gold,predictor=NULL,predictor.binary=NULL,important="se",plot=TRUE,positive='l'){

  error=FALSE
  roc.gold=as.numeric(as.factor(gold))-1
  table.gold=2-as.numeric(as.factor(gold))
